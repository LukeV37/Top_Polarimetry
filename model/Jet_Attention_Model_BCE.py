...
def train(X_train_jet, X_train_jet_trk, X_train_trk, y_train, y_train_jet_trk,
    ...
    for e in range(epochs):
        ...
        for i in range(num_train):
            ...
            jet_loss=BCE_loss_fn(output, y_train[i].to(device))
            jet_trk_loss=CCE_loss_fn(jet_trk_output, y_train_jet_trk[i].to(device))

            loss = jet_loss + jet_trk_loss
            #loss = jet_loss
        ...
        for i in range(num_val):
            ...
            jet_loss=BCE_loss_fn(output, y_val[i].to(device))
            jet_trk_loss=CCE_loss_fn(jet_trk_output, y_val_jet_trk[i].to(device))
...
for i in range(num_test):
    ...
    jet_loss=BCE_loss_fn(output, y_test[i].to(device))
    jet_trk_loss=CCE_loss_fn(jet_trk_output, y_test_jet_trk[i].to(device))
