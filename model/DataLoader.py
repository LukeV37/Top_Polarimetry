    ...
    def __init__(self, files):
        ...
        for i, file in enumerate(files):
            if i==0:
                ...
                lepton_feats_tmp, nu_feats_tmp, probe_jet_feats_tmp, probe_jet_constituent_feats_tmp, balance_jets_feats_tmp, truth_labels_tmp, track_labels_tmp = load_file(file)
                ...
                track_labels = torch.cat([track_labels, track_labels_tmp], dim=0)
...
torch.save(dset, "dataset"+tag+".pt")
